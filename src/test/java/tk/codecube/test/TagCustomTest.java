...
import tk.codecube.test.aop.CglibProxy;
import tk.codecube.test.aop.ForumService;
import tk.codecube.test.aop.ForumServiceImpl;
import tk.codecube.test.aop.PerformanceHandler;
...
public class TagCustomTest {
	...
	public void springBeanLife() {
		Resource res = new ClassPathResource(
				"spring/spring-beanlifecycle-test.xml");
	...
	public void springLookUpTest() {
		Resource rse = new ClassPathResource(
				"spring/spring-lookupandreplace-test.xml");
		DefaultListableBeanFactory dlb = new DefaultListableBeanFactory();
	...
	public void EncryptPlaceHolderConfigerTest() {
		/*
		 * Resource res = new
		 * ClassPathResource("spring/spring-encryptplace-test.xml");
		...
		ApplicationContext ac = new ClassPathXmlApplicationContext(
				"spring/spring-encryptplace-test.xml");
	 ...
	 */
	@Test
	public void AopMointorTestJCglibProxy() {
