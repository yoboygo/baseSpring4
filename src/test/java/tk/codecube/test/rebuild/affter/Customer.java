...
public class Customer {
	...
	public void printOrderDetail() {
		...
		for (Rentail e : rentail) {
			...
			System.out.println("Price: " + e.getMovieBaseCharge());
			System.out.println("Start: "
					+ df.format(e.getStartDate().getTime()));
			System.out.println("End: " + df.format(e.getEndDate().getTime()));
			System.out.println("PerDay: " + e.getMovieChargePerDay());
			System.out.println("RentainDays: " + e.getRetailDays());
			System.out.println("RetainCost: " + e.getRentalCharge());
			System.out.println("total:"
					+ (e.getMovieBaseCharge() + e.getRentalCharge()));

			charge += e.getMovieBaseCharge() + e.getRentalCharge();
		}
